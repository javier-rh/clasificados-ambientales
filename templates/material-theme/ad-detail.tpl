            ...
            <article class="inner">
                <header>
                    ...
                    <ul class="info-list">
                        ...
                        <li style="display:none;"><i class="fa fa-bookmark"></i>{LANG_ID}: {ITEM_ID}</li>
                    </ul>
                </header>
                ...
                <section id="send-message">
                    ...
                    <div class="property-description detail-block">
                        <div class="detail-title">
                            <h2 class="title-left">{LANG_EMAIL} a {ITEM_AUTHORUNAME}</h2>
                        </div>
            ...
            <div class="inner">
                ...
                <div class="user-widget text-center">
                    ...
                    <div style="padding: 10px 0;">
                        <a href="#">
                            <button type="button" class="btn btn-warning" href="#" onclick="javascript:chatWith('{ITEM_AUTHORUNAME}','{ITEM_AUTHORIMG}','{ITEM_AUTHORONLINE}')">
                    ...
                    <div style="padding: 10px 0;">
                        <a href="#send-message">
                            <button type="button" class="btn btn-primary">{LANG_REPLY-MAIL}</button>
                        </a>
                    </div>
                    {:IF}
