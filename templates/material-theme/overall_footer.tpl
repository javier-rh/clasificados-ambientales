<a class="buttom-btn" href="/contact"><i class="fa fa-envelope"></i></a>
<style>
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="footer-widget widget-contact" style="height: 165px;">
                        <div class="widget-top">
                            <h3 class="widget-title">Acerca de Clasificados Ambientales</h3>
                        </div>
                        <div class="widget-body">
                ...
                <div class="col-sm-3">
                    <div class="footer-widget widget-contact" style="height: 165px;">
                        <div class="widget-top">
                            <h3 class="widget-title">{LANG_HELP}</h3>
                        </div>
                        <div class="widget-body">
                            <ul class="list-unstyled">
                                <li><i class="fa fa-angle-double-right"></i> <a href="{LINK_FAQ}">{LANG_FAQ}</a></li>
