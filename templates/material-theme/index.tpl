                                        ...
                                        <div class="row">
                                            <div class="col-md-5 col-sm-5">
                                                <div class="input-field">
                                                    <input type="text" name="keywords" placeholder="¿Qué está buscando?" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-3">
                                                <div class="form-group input-field tg-inputwithicon live-location-search" id="country-popup">
                                                    ...
                                                    <input type="text" id="inputStateCity" name="location" placeholder="¿En que ciudad desea buscar?" autocomplete="off">
