                    ...
                    <div class="header-widget">
                        ...
                        <div class="user-menu">
                            ...
                            <ul>
                                ...
                                <li><a href="{LINK_PROFILE}/{USERNAME}"><i class="fa fa-user"></i> {LANG_MY-PROFILE}</a></li>
                                ...
                                <li><a href="{LINK_ACCOUNT_SETTING}"><i class="fa fa-cog"></i> {LANG_ACCOUNT-SETTING}</a></li>
                ...
                <div class="nav-right">
                    ...
                    <div class="dropdown language-dropdown"><i class="fa fa-user"></i>
                        ...
                        <ul class="dropdown-menu language-change">
                            ...
                            <li><a href="{LINK_ACCOUNT_SETTING}">{LANG_ACCOUNT-SETTING}</a></li>
