                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="box box-info">
                                ...
                                <div class="box-body">
                                    ...
                                    <h5><b><u><?php echo $lang['lugar']; ?></u></b></h5>
                                ...
                                <div class="box-body">
                                    <form role="form" method="post" id="addform"> 
                                        ...
                                        <div class="form-group">	
                                            <label><?php echo $lang['your']; ?> <?php echo $lang['budget']; ?></label>
                                        ...
                                        <div class="form-group">	
                                            <label><?php echo $lang['descripcion_presupuesto']; ?></label>
                                            <textarea type="text" id="summernote" name="description" class="form-control"></textarea>
                                        </div>     

                                        <div class="box-footer">
                                            <input type="hidden" name="token" value="<?php echo Token::generate(); ?>" />
                                            <button type="submit" name="data" class="btn btn-primary full-width"><?php echo $lang['agregar']; ?></button>
                                        </div>
                                    </form> 
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
