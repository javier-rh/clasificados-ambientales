                ...
                <section class="content">	
                                ...
                                <div class="btn-group pull-right">
                                    <?php if ($job_completed === '1'): ?>			
                                        <a class="btn btn-sm btn-danger"> 
                                            <?php echo $lang['clasificado']; ?> <?php echo $lang['completed']; ?>, 
                                            <?php echo $lang['now']; ?> <?php echo $lang['rate']; ?> <?php echo $lang['client']; ?> 			
                                        </a>
                                    <?php else: ?>		
                                        <a class="btn btn-sm btn-success"> 
                                            <i class="fa fa-spinner"></i> &nbsp; <?php echo $lang['clasificado']; ?> <?php echo $lang['not']; ?> <?php echo $lang['finished']; ?>			
                                        </a>
                                    <?php endif; ?>
                                </div>
                            </div>
                    ...
                    <div class="row proj-summary-band nav-bg">
                        <div class="col-md-3 text-center">
                            <label class="small text-muted"><?php echo $lang['clasificado']; ?></label>
                            <h4><strong><?php echo escape($job_title); ?></strong></h4>
                        </div>
                        <div class="col-md-3 text-center">
                            <label class="text-muted small"><?php echo $lang['budget']; ?> del <?php echo $lang['clasificado']; ?></label>
                            <h4><strong>
                                    <?php echo $currency_symbol; ?> <?php echo escape($job_budget); ?>	
                                </strong></h4>
                        </div>
                        <div class="col-md-3 text-center">
                            <label class="small text-muted"><?php echo $lang['type']; ?> de <?php echo $lang['clasificado']; ?></label>
                            <h4><strong><?php echo escape($job_type); ?></strong></h4>
                        </div>
                        <div class="col-md-3 text-center">
                            <label class="text-muted small"><?php echo $lang['budget']; ?> de <?php echo $lang['freelancer']; ?></label>
                            <h4><strong>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <section class="panel panel-default">
                                    <header class="panel-heading"><?php echo $lang['detalles_clasificado']; ?></header>
                                    <ul class="list-group no-radius">
                                        ...
                                        <li class="list-group-item">
                                            <?php if ($job_completed === '1'): ?>		
                                                <span class="pull-right text"><?php echo $lang['clasificado']; ?> <?php echo $lang['completed']; ?></span>
                                            <?php else: ?>		
                                                <span class="pull-right text"><?php echo $lang['clasificado']; ?> <?php echo $lang['not']; ?> <?php echo $lang['finished']; ?></span>
                                            <?php endif; ?>
                                            <span class="text-muted"><?php echo $lang['estatus']; ?></span>
                                        </li>
                                        <li class="list-group-item">
                                            ...
                                            <span class="text-muted"><?php echo $lang['company']; ?></span>
                                        </li>
                                        <li class="list-group-item">
                                            <span class="pull-right text"><?php echo escape($job_type); ?></span>
                                            <span class="text-muted"><?php echo $lang['type']; ?> de <?php echo $lang['clasificado']; ?></span>
                                        </li>
                                        <li class="list-group-item">
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <span class="text-muted"><?php echo $lang['fecha_inicio']; ?></span>
                                        </li>
                                        <li class="list-group-item">
                                            <span class="pull-right"><?php echo escape($job_end_date); ?></span>
                                            <span class="text-muted"><?php echo $lang['fecha_fin']; ?></span>
                                        </li>
                                    </ul>
                                </section>	

                                <section class="panel panel-default">
                                    <header class="panel-heading"><?php echo $lang['proposal']; ?> del <?php echo $lang['freelancer']; ?></header>
                                    <ul class="list-group no-radius">
                                        <li class="list-group-item">
                                ...
                                <div class="box box-info">
                                    <div class="box-header">
                                        <h3 class="box-title"><?php echo $lang['skills']; ?> para el <?php echo $lang['clasificado']; ?></h3>
                                    </div>
                                    <div class="box-body">
                    ...
                    <?php elseif (Input::get('a') == 'milestones') : ?> 
                        <div class="row">	
                            ...
                            <div class="col-md-12">
                                <div class="box box-info">
                                    <div class="box-header">
                                        <h3 class="box-title"><?php echo $lang['milestones']; ?></h3>
                                    </div><!-- /.box-header -->
                                    <div class="box-body">
                                    ...
                                    <div class="col-lg-6">	
                                        <section class="panel panel-default">
                                            <ul class="list-group no-radius">
                                                <li class="list-group-item">
                                                    <span class="pull-right text"><?php echo escape($job_title); ?></span>
                                                    <span class="text-muted"><?php echo $lang['clasificado']; ?> <?php echo $lang['title']; ?></span>
                                                </li>
                                                <li class="list-group-item">
                    ...
                    <?php elseif (Input::get('a') == 'funds') : ?> 	 	
                            <div class="row">	
                                <div class="col-md-12">
                                    <div class="box box-info">
                                        <div class="box-header">
                                            <h3 class="box-title"><?php echo $lang['payments']; ?> <?php echo $lang['funds']; ?> <?php echo $lang['paid']; ?> <?php echo $lang['for']; ?> <?php echo $lang['this']; ?> <?php echo $lang['clasificado']; ?></h3>
                                        </div><!-- /.box-header -->
                                        <div class="box-body">
                                            <div class="table-responsive">
                                                <table id="example1" class="table table-bordered table-striped">
                                                    <thead>
                                                        <tr>
                                                            <th><?php echo $lang['milestone']; ?> <?php echo $lang['name']; ?></th>
                                                            <th><?php echo $lang['clasificado']; ?> <?php echo $lang['title']; ?></th>
                                                                        ...
                                                                        if ($query->count()) {
                                                                            foreach ($query->results() as $row) {
                                                                                ...
                                                                                elseif (escape($row->transaction_type) == 3):
                                                                                    echo '<td><span class="label label-success"> ' . $lang['payment'] . ' ' . $lang['for'] . ' ' . $lang['boosting'] . ' ' . $lang['of'] . ' ' . $lang['clasificado'] . ' </span> </td>';
                                                                                elseif (escape($row->transaction_type) == 4):
                                                                                    echo '<td><span class="label label-success"> ' . $lang['payment'] . ' ' . $lang['for'] . ' ' . $lang['clasificado'] . ' ' . $lang['work'] . ' </span> </td>';
                                                                                endif;
                                ...
                                <div class="col-lg-12">	  
                                    ...
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            $percentage = round($percentage, 1);
                                            ?>
                                            <h3><?php echo $lang['clasificado']; ?> <?php echo $lang['success']; ?> <?php echo $lang['score']; ?></h3>
