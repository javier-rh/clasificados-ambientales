        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1><?php echo $lang['withdrawal']; ?></small></h1>
                    <ol class="breadcrumb">
                    ...
                    <div class="row">	
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="box box-info">
                                    <div class="box-header">
                                        <h3 class="box-title"><?php echo $lang['configuracion_retiro']; ?> Paypal</h3>
                                    </div>
                                    <div class="box-body">
                                        <form role="form" method="post" id="addform"> 
                                            ...
                                            <div class="box-footer">
                                                ...
                                                <button type="submit" name="data_paypal" class="btn btn-primary full-width"><?php echo $lang['siguiente']; ?></button><br/><br />
                        ...
                        <?php elseif (Input::get('id') === '2') :
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="box box-info">
                                    <div class="box-header">
                                        <h3 class="box-title"><?php echo $lang['configuracion_retiro']; ?> Stripe</h3>
                                    </div>
                                    <div class="box-body">
                                        <form role="form" method="post" id="addform"> 
                                            ...
                                            <div class="box-footer">
                                                <input type="hidden" name="token" value="<?php echo Token::generate(); ?>" />
                                                <button type="submit" name="data_stripe" class="btn btn-primary full-width"><?php echo $lang['siguiente']; ?></button><br/><br />
                                                <a href="withdraw.php" class="btn btn-info full-width"><?php echo $lang['back']; ?></a>
                                            </div>
                                        </form> 
                                    </div><!-- /.box-body -->
                        ...
                        <?php elseif (Input::get('id') === '3') :
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="box box-info">
                                    <div class="box-header">
                                        <h3 class="box-title"><?php echo $lang['configuracion_retiro']; ?> Skrill</h3>
                                    </div>
                                    <div class="box-body">
                                        <form role="form" method="post" id="addform"> 
                                            ...
                                            <div class="box-footer">
                                                <input type="hidden" name="token" value="<?php echo Token::generate(); ?>" />
                                                <button type="submit" name="data_skrill" class="btn btn-primary full-width"><?php echo $lang['siguiente']; ?></button><br/><br />
                                                <a href="withdraw.php" class="btn btn-info full-width"><?php echo $lang['back']; ?></a>
                                            </div>
                                        </form> 
                                    </div><!-- /.box-body -->
