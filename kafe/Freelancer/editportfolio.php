        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1><?php echo $lang['galeria']; ?></h1>
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fa fa-dashboard"></i> <?php echo $lang['home']; ?></a></li>
                        <li class="active"><?php echo $lang['edit']; ?> <?php echo $lang['galeria']; ?></li>
                    </ol>
                </section>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="list-group">
                                <a href="editportfolio.php?a=data&id=<?php echo $portfolioid ?>" class="list-group-item<?php echo $selected; ?>">
                                    <em class="fa fa-fw fa-user-md text-white"></em>&nbsp;&nbsp;&nbsp;Detalles
                                </a>
                                <a href="editportfolio.php?a=image&id=<?php echo $portfolioid ?>" class="list-group-item<?php echo $image; ?>">
                                    <em class="fa fa-fw fa-image text-white"></em>&nbsp;&nbsp;&nbsp;<?php echo $lang['image']; ?>
                                </a>
                            ...
                            <?php if (Input::get('a') == 'data') : ?>
                                ...
                                <div class="box box-info">
                                    <div class="box-header">
                                        <h3 class="box-title"><?php echo $lang['edit']; ?> <?php echo $lang['details']; ?></h3>
                                    </div>
                                    <div class="box-body">
                            ...
                            <?php elseif (Input::get('a') == 'image') : ?>
                                ...
                                <div class="box box-info">
                                    ...
                                    <form role="form" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="box-footer">
                                            <input type="hidden" name="token" value="<?php echo Token::generate(); ?>" />
                                            <button type="submit" name="picture" class="btn btn-primary full-width"><?php echo $lang['guardar']; ?></button><br></br>
                                        </div>
