            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><?php echo $lang['mi_perfil']; ?></li>
                    </ol>
                </section>
                    ...
                    <div class="row">	
                        ...
                        <div class="col-lg-8">
                                    ...
                                    <div class="box-body">
                                        <form role="form" method="post" id="addstudentform"> 
                                            ...
                                            <div class="box-footer">
                                                ...
                                                <button type="submit" name="form_profile" class="btn btn-primary full-width"><?php echo $lang['guardar']; ?></button>
                                            </div>
                                        </form> 
                                    </div><!-- /.box-body -->
                                </div><!-- /.box -->
                            ...
                            <?php elseif (Input::get('a') == 'about') : ?>
                                ...
                                <div class="box box-info">
                                    <div class="box-header">
                                        <h3 class="box-title"><?php echo $lang['edit']; ?> <?php echo $lang['about']; ?></h3>
                                    </div>
                                    <div class="box-body">
                                        <form role="form" method="post" id="editform">              
                                            ...
                                            <div class="box-footer">
                                                <input type="hidden" name="token" value="<?php echo Token::generate(); ?>" />
                                                <button type="submit" name="form_about" class="btn btn-primary full-width"><?php echo $lang['guardar']; ?></button>
                                            </div>
                                        </form> 
                                    </div><!-- /.box-body -->
                                </div><!-- /.box -->
                            <?php elseif (Input::get('a') == 'education') : ?>
                                ...
                                <div class="box box-info">
                                    <div class="box-header">
                                        <h3 class="box-title"><?php echo $lang['edit']; ?> <?php echo $lang['education']; ?></h3>
                                    </div>
                                    <div class="box-body">
                                        <form role="form" method="post" id="editform">              
                                            ...
                                            <div class="box-footer">
                                                <input type="hidden" name="token" value="<?php echo Token::generate(); ?>" />
                                                <button type="submit" name="form_education" class="btn btn-primary full-width"><?php echo $lang['guardar']; ?></button>
                                            </div>
                                        </form> 
                                    </div><!-- /.box-body -->
                                </div><!-- /.box -->
                            ...
                            <?php elseif (Input::get('a') == 'work') : ?>	 
                                ...
                                <div class="box box-info">
                                    <div class="box-header">
                                        <h3 class="box-title"><?php echo $lang['edit']; ?> <?php echo $lang['work']; ?></h3>
                                    </div>
                                    <div class="box-body">
                                        <form role="form" method="post" id="editform">              
                                            ...
                                            <div class="box-footer">
                                                <input type="hidden" name="token" value="<?php echo Token::generate(); ?>" />
                                                <button type="submit" name="form_work" class="btn btn-primary full-width"><?php echo $lang['guardar']; ?></button>
                                            </div>
                                        </form> 
                                    </div><!-- /.box-body -->
                                </div><!-- /.box -->
                            ...
                            <?php elseif (Input::get('a') == 'awards') : ?>
                                ...
                                <div class="box box-info">
                                    <div class="box-header">
                                        <h3 class="box-title"><?php echo $lang['edit']; ?> <?php echo $lang['awards']; ?></h3>
                                    </div>
                                    <div class="box-body">
                                        <form role="form" method="post" id="editform">              
                                            ...
                                            <div class="box-footer">
                                                <input type="hidden" name="token" value="<?php echo Token::generate(); ?>" />
                                                <button type="submit" name="form_awards" class="btn btn-primary full-width"><?php echo $lang['guardar']; ?></button>
                                            </div>
                                        </form> 
                                    </div><!-- /.box-body -->
                                </div><!-- /.box -->     
                            ...
                            <?php elseif (Input::get('a') == 'skills') : ?>
                                ...
                                <div class="box box-info">
                                    <div class="box-header">
                                        <h3 class="box-title"><?php echo $lang['edit']; ?> <?php echo $lang['skills']; ?></h3>
                                    </div>
                                    <div class="box-body">
                                        <form role="form" method="post" id="editform">  
                                            ...
                                            <div class="form-group">	
                                                <div class="input-group">
                                                    ...
                                                    <select class="selectpicker form-control" name="skills_name[]" type="text" title="Elige las que apliquen" data-live-search="true" data-width="30%" data-selected-text-format="count > 3" multiple="multiple">
                                                        <?php
                                                        $query = DB::getInstance()->get("profile", "*", ["userid" => $freelancer->data()->freelancerid, "LIMIT" => 1]);
                                                        if ($query->count()) {
                                                            foreach ($query->results() as $row) {
                                            ...
                                            <div class="box-footer">
                                                <input type="hidden" name="token" value="<?php echo Token::generate(); ?>" />
                                                <button type="submit" name="form_skills" class="btn btn-primary full-width"><?php echo $lang['guardar']; ?></button>
                                            </div>
                                        </form>                  
                                    </div><!-- /.box-body -->
                                </div><!-- /.box -->    
