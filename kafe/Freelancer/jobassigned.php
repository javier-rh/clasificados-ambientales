            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><?php echo $lang['clasificados_asignados']; ?></li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-info">
                                <div class="box-header">
                                    <h3 class="box-title"><?php echo $lang['clasificados_asignados']; ?></h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                    <div class="table-responsive">
                                        <table id="example1" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    <th><?php echo $lang['clasificado']; ?></th>
                                                    <th><?php echo $lang['category']; ?></th>
                                                    <th><?php echo $lang['budget']; ?></th>
                                                    <th><?php echo $lang['fecha_fin_estimado']; ?></th>
                                                ...
                                                if ($query->count()) {
                                                    foreach ($query->results() as $row) {
                                                        ...
                                                        if ($q->count() === 1) {
                                                            ...
                                                            $view .= '
					      <a href="jobboard.php?a=overview&id=' . escape($row->jobid) . '" class="btn btn-primary btn-xs" data-toggle="tooltip" title="' . $lang['view'] . ' ' . $lang['clasificado'] . '"><span class="fa fa-eye"></span></a>';
                                                        } else {
                                                            $link .= '<a href="../jobpost.php?title=' . escape($row->slug) . '" target="_blank">' . escape($row->title) . '</a>';
                                                            $view .= '
					      <a href="../jobpost.php?title=' . escape($row->slug) . '" target="_blank" class="btn btn-primary btn-xs" data-toggle="tooltip" title="' . $lang['view'] . ' ' . $lang['clasificado'] . '"><span class="fa fa-eye"></span></a>';
                                                        }
