...
<header class="header-jobs" style="
  ...
  ">
	<div class="container">
		<div class="content">
			<div class="row">
				<h2>¿Quieres contratar un servicio ambiental?</h2>
				<?php
				$admin = new Admin();  //Start new Admin object
				$client = new Client();  //Start new Client object
				$freelancer = new Freelancer();   //Start new Freelancer object
				
				if ($admin->isLoggedIn()) { ?>
				<?php } elseif($freelancer->isLoggedIn()) { ?>
				<?php } elseif($client->isLoggedIn()) { ?>
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
						<a href="Client/addjob.php"
						class="kafe-btn kafe-btn-mint full-width revealOnScroll" 
						data-animation="bounceIn" data-timeout="400">
							<i class="fa fa-tags"></i> <?php echo  $lang['agregar_clasificado'] ?>
						</a>
					</div><!-- /.col-lg-3 -->
				<?php } else { ?>
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
						...
						data-timeout="400">
							<i class="fa fa-tags"></i> <?php echo $lang['send'] . ' ' . $lang['proposal']; ?>
						</a>
					</div><!-- /.col-lg-3 -->
				<?php } ?>	
			</div><!-- /.row -->
	    ...
	    <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 white">	
		 ...
		 <form action="search.php" method="get" class="list-search revealOnScroll" data-animation="fadeInDown" data-timeout="200">
		  ...
		  <input type="text" 
		  		class="form-control" 
				name="searchterm" 
				placeholder="<?php echo $lang['title'] . ' ' . $lang['its'] . ' ' . strtolower($lang['job']); ?>, <?php echo strtolower($lang['keywords']); ?> <?php echo $lang['or']; ?> <?php echo strtolower($lang['name']) . ' ' .  $lang['la'] . ' ' . strtolower($lang['company']); ?>"
				value=""/>   
				 ...
				 <div class="job">	
				  ...
				  <div class="row bottom-sec">
				   <div class="col-lg-12">
					...
					<div class="col-lg-2">
					 <h5>' . $lang['propuestas_de_trabajo'] . '</h5>
