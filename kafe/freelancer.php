...
<body class="greybg">
  ...
  text-align: center;">
	     ...
	     <div class="col-lg-12">
		  ...
		  <?php
			 ...
			 if ($admin->isLoggedIn()) { 
							...
							echo $sen .='<a href="Client/invite.php?id='.
							escape($freelancerid) .
							'" class="kafe-btn kafe-btn-mint-small">
							<i class="fa fa-align-left"></i> ' .
							$lang['contactar_contratista'] .
							 '</a>';
			} else {
	         echo $sen .='	 
				 <a href="login.php" class="kafe-btn kafe-btn-mint-small">
				 <i class="fa fa-align-left"></i> ' . $lang['contactar_contratista'] . '</a>
			 ';
			 }
			?> 		  
		 </div><!-- /.col-lg-12 -->
						...
						<div class="about">
							...
							<div class="row bottom-sec">
								<div class="col-lg-12">
									...
									<div class="col-lg-3">
										<h5>Peticiones de trabajo </h5>
										<p>
											<?php $query = DB::getInstance()->get("job", "*", ["AND" => ["freelancerid" => $freelancerid, "invite" => 1]]);
											echo $query->count(); ?>	
										</p>
									</div><!-- /.col-lg-2 -->
									<div class="col-lg-3">
										<h5>Trabajos en proceso </h5>
										<p>
											<?php $query = DB::getInstance()->get("job", "*", ["AND" => ["freelancerid" => $freelancerid, "accepted" => 1]]);
											echo $query->count(); ?>	
										</p>
									</div><!-- /.col-lg-2 -->
									<div class="col-lg-3">
										...
										<p>
											<?php $query = DB::getInstance()->get("job", "*", ["AND" => ["freelancerid" => $freelancerid, "completed" => 1]]);
											echo $query->count(); ?>	
										</p>
									</div><!-- /.col-lg-2 -->
								</div><!-- /.col-lg-12 -->
	...
	echo '<h3>Calificación Laboral'. /*$lang['job'] .' '.$lang['success'] .' '. $lang['score'].*/'</h3>';
