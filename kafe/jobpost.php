	  ...
	  <div class="container">
	   <div class="row">
	    <div class="col-lg-8 white">
		 ...
		 <div class="row">
		  <div class="col-lg-12">
		   <h6><a href="jobs.html"><?php echo $lang['categoria']; ?>: <?php echo $cat_name; ?></a></h6>
		 ...
		 <div class="row post-top-sec">
		  ...
		  <div class="col-lg-3">
		   <h5> <?php echo $lang['propuestas_de_trabajo']; ?> </h5>
		 ...
		 <div class="row post-top-sec">
		  <div class="col-lg-3">
		   <h5><?php echo $lang['fecha_inicio']; ?></h5>
		   <p><?php echo $start_date; ?></p>
		  </div><!-- /.col-lg-3 -->
		  <div class="col-lg-3">
		   <h5><?php echo $lang['fecha_fin']; ?></h5>
		   <p><?php echo $end_date; ?></p>
		  </div><!-- /.col-lg-3 -->
		  <div class="col-lg-3">
		   <h5><?php echo $lang['tipo_trabajo']; ?></h5>
		   <p><?php echo $job_type; ?></p>
		  </div><!-- /.col-lg-3 -->
		  <div class="col-lg-3">
		   <h5><?php echo $lang['estatus_trabajo']; ?></h5>
		   <p><?php 
		         if($accepted === 1):
					  if($completed === '1'):	 
					   echo $lang['completed'];	
	    ...
	    <div class="col-lg-4">
		 ...
		 <div class="panel user-client revealOnScroll" data-animation="slideInUp" data-timeout="200">
		  ...
		  <div class="list-group">
           <div class="list-group-item">&nbsp;&nbsp;&nbsp;Trabajos publicados<?php /*echo $lang['jobs']; ?> <?php echo $lang['posted']; */?>
            <span class="badge">
            <?php	
           ...
           <div class="list-group-item">&nbsp;&nbsp;&nbsp;Trabajos invitados<?php /*echo $lang['jobs']; ?> <?php echo $lang['invites']; */?>
            <span class="badge">
            <?php	
           ...
           <div class="list-group-item">&nbsp;&nbsp;&nbsp;Trabajos completados<?php /*echo $lang['jobs']; ?> <?php echo $lang['completed'];*/ ?>
            <span class="badge">
            <?php	
           ...
           <?php /*<div class="list-group-item">&nbsp;&nbsp;&nbsp;Trabajos pagados<?php echo $lang['job']; ?> <?php echo $lang['payments']; ?>
            <span class="badge">
        	<?php
		 ...
		 <div class="list">
		  <div class="list-group">
           <span class="list-group-item active cat-top">
            <em class="fa fa-fw fa-coffee"></em>&nbsp;&nbsp;&nbsp;Compartir este clasificado
		   </span>
