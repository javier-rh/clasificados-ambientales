            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><?php echo $lang['editar_clasificado']; ?></li>
                    </ol>
                </section>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="box box-info">
                                <div class="box-header">
                                    <h3 class="box-title"><?php echo $lang['informacion_clasificado']; ?></h3>
                                </div>
                                <div class="box-body">
...
<?php if ($public === "1") { ?>	
                                        ...
                                        <div class="box-footer">
                                            ...
                                            <button type="submit" name="details" class="btn btn-primary full-width"><?php echo $lang['guardar']; ?></button>
                                        </div>
                                    </form> 
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
