            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><?php echo $lang['lista_clasificados']; ?></li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-info">
                                <div class="box-header">
                                    <h3 class="box-title"><?php echo $lang['lista_clasificados']; ?></h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                    <div class="table-responsive">
                                        <table id="example1" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    <th><?php echo $lang['titulo_clasificado']; ?></th>
					      ...
					      <a id="' . escape($row->id) . '" class="btn btn-danger btn-xs" data-toggle="tooltip" title="' . $lang['delete'] . '"><span class="fa fa-trash"></span></a>';
						    ...
						    <a href="paymentlist.php" class="btn btn-info btn-xs">' . $lang['view'] . ' ' . $lang['payment'] . '</a>';
                                                        ...
                                                        elseif ($row->accepted === "0"):
                                                            echo '<td><span class="label label-success"> ' . $lang['esperando_ser_asignado'] . ' </span> </td>';
                                                        endif;
                                                        ...
                                                        if (escape($row->featured) == 1) {
                                                            echo '<td><span class="label label-success"> ' . $lang['destacado'] . ' </span> </td>';
                                                        } else {
                                                            echo '<td><span class="label label-success"> ' . $lang['no_destacado'] . '</span> </td>';
                                                        }
