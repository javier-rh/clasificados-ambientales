...
echo $active = ($basename == 'addjob') ? ' active' : '';
echo $active = ($editname == 'editjob.php?id=' . Input::get('id') . '') ? ' active' : ''; ?>">
                <a href="#"><i class='fa fa-align-left'></i> <span><?php echo $lang['clasificados']; ?></span> <i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                    <li><a href="joblist.php"><?php echo $lang['lista_clasificados']; ?></a></li>
                    <li><a href="addjob.php"><?php echo $lang['agregar_clasificado']; ?></a></li>
                </ul>
            </li> 
            <li class="treeview<?php echo $active = ($basename == 'jobinvite') ? ' active' : '';
echo $active = ($basename == 'addinvite') ? ' active' : '';
echo $active = ($editname == 'editinvite.php?id=' . Input::get('id') . '') ? ' active' : '';
echo $active = ($editname == 'invite.php?id=' . Input::get('id') . '') ? ' active' : '';
echo $active = ($editname == 'viewinvite.php?id=' . Input::get('id') . '') ? ' active' : ''; ?>">
                <a href="#"><i class='fa fa-filter'></i> <span><?php echo $lang['invitaciones_trabajo']; ?></span> <i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                    <li><a href="jobinvite.php"><?php echo $lang['lista_invitacion_trabajo']; ?></a></li>
                    <li><a href="addinvite.php"><?php echo $lang['invitar_contratista']; ?></a></li>
                </ul>
            </li> 
            <li class="treeview<?php echo $active = ($basename == 'proposallist') ? ' active' : '';
echo $active = ($editname == 'proposallist.php?id=' . Input::get('id') . '') ? ' active' : '';
...
?></span></a>
            ...
            <li class="<?php echo $active = ($basename == 'jobassigned') ? ' active' : '';
echo $active = ($editname == 'jobboard.php?a=' . Input::get('a') . '&id=' . Input::get('id') . '') ? ' active' : ''; ?>">
            ...
            <li class="<?php echo $active = ($basename == 'paymentlist') ? ' active' : ''; ?>">
                <a href="paymentlist.php"><i class='fa fa-list'></i> <span><?php echo $lang['lista_pagos']; ?></span></a>
            </li>  
            ...
            <li class="treeview<?php echo $active = ($basename == 'inbox') ? ' active' : '';
