        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1><?php echo $lang['clasificado']; ?></h1>
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fa fa-dashboard"></i> <?php echo $lang['home']; ?></a></li>
                        <li class="active"><?php echo $lang['agregar_clasificado']; ?></li>
                    </ol>
                </section>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="box box-info">
                                <div class="box-header">
                                    <h3 class="box-title"><?php echo $lang['nuevo_clasificado']; ?></h3>
                                </div>
                                <div class="box-body">
                                    <form role="form" method="post" id="addform"> 
                                        ...
                                        <div class="box-footer">
                                            ...
                                            <button type="submit" name="data" class="btn btn-primary full-width"><?php echo $lang['crear']; ?></button>
                                        </div>
                                    </form> 
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
