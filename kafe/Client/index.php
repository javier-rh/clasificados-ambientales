            ...
            <div class="row">
                <div class="col-xs-12 col-md-6">
                    <section class="panel panel-default panel-dashboard">
                        <header class="panel-heading font-bold"><?php echo $lang['clasificados']; ?></header>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-xs-12 col-md-6">
                                    <a href="joblist.php" class="btn btn-success btn-lg"><i class="fa fa-list-ul"></i> <?php echo $lang['lista_clasificados']; ?></a>
                                </div>
                                <div class="col-xs-12 col-md-6">
                                <a href="addjob.php" class="btn btn-success btn-lg"><i class="fa fa-plus-circle"></i> <?php echo $lang['agregar_clasificado']; ?></a>
                                </div>
                            </div>
                        </div> 
                    </section>
                ...
                <div class="col-xs-12 col-md-6">
                    <section class="panel panel-default panel-dashboard">
                        <header class="panel-heading font-bold"><?php echo $lang['invitaciones_trabajo']; ?></header>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-xs-12 col-md-6">
                                <a href="jobinvite.php" class="btn btn-success btn-lg"><i class="fa fa-list-ul"></i> <?php echo $lang['invitaciones_trabajo']; ?></a>
                                </div>
                                <div class="col-xs-12 col-md-6">
                                <a href="addinvite.php" class="btn btn-success btn-lg"><i class="fa fa-plus-circle"></i> <?php echo $lang['invitar_contratista']; ?></a>
                                </div>
                            </div>
                        </div> 
                    </section>
                ...
                <div class="col-xs-12 col-md-6">
                    <section class="panel panel-default panel-dashboard">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-xs-12 col-md-6">
                                <a href="proposallist.php" class="btn btn-success btn-lg"><i class="fa fa-bell"></i> <?php echo $lang['proposals']; ?></a>
                                </div>
                                <div class="col-xs-12 col-md-6">
                                <a href="jobassigned.php" class="btn btn-success btn-lg"><i class="fa fa-tag"></i> <?php echo $lang['clasificados_asignados']; ?></a>
                                </div>
                            </div>
                        </div> 
                    </section>
                ...
                <div class="col-xs-12 col-md-6">
                    <section class="panel panel-default panel-dashboard">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-xs-12 col-md-6">
                                <a href="paymentlist.php" class="btn btn-success btn-lg"><i class="fa fa-usd"></i> <?php echo $lang['lista_pagos']; ?></a>
                                </div>
                                <div class="col-xs-12 col-md-6">
                                <a href="overview.php?a=profile" class="btn btn-success btn-lg"><i class="fa fa-user"></i> <?php echo $lang['mi_perfil']; ?></a>
                                </div>
                            </div>
                        </div> 
                    </section>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-4">
                    <div class="info-box">
                        <span class="info-box-icon bg-aqua"><i class="fa fa-align-left"></i></span>
                        <div class="info-box-content">
                            <span class="info-box-text"><?php echo $lang['clasificados']; ?></span>
                            <span class="info-box-number">
                                <a href="joblist.php"><?php echo $lang['lista_clasificados']; ?></a>
                                <a href="addjob.php"><?php echo $lang['agregar_clasificado']; ?></a>
                            </span>
                        </div><!-- /.info-box-content -->
                    </div><!-- /.info-box -->
                </div>
