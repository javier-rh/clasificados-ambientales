...
<?php include ('template/sidenav.php'); ?> 
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1><?php echo $lang['invitaciones_trabajo']; ?></h1>
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fa fa-dashboard"></i> <?php echo $lang['home']; ?></a></li>
                        <li class="active"><?php echo $lang['invitar_contratista']; ?></li>
                    </ol>
                </section>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="box box-info">
                                <div class="box-header">
                                    <h3 class="box-title"><?php echo $lang['invitacion_trabajo_contratista']; ?></h3>
                                </div>
                                <div class="box-body">
...
?>	
                                        ...
                                        <div class="form-group">	
                                            <label><?php echo $lang['titulo_clasificado']; ?></label>
                                            <div class="input-group">
...
?>	
                                        ...
                                        <div class="form-group">	
                                            <label><?php echo $lang['tipo_de_trabajo']; ?></label>
                                            <div class="radio">
                                        ...
                                        <div class="form-group">
                                            <label for="dtp_input1"><?php echo $lang['fecha_inicio_estimado']; ?></label>
                                        ...
                                        <div class="form-group">
                                            <label for="dtp_input1"><?php echo $lang['fecha_fin_estimado']; ?></label>
                                            <div class="input-group date form_datetime_start" data-date-format="dd MM yyyy" data-link-field="dtp_input1">
                                        ...
                                        <div class="form-group">	
                                            <label><?php echo $lang['habilidades_trabajo']; ?></label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-pencil-square"></i></span>
                                                <select class="selectpicker form-control" name="skills_name[]" type="text" title="Selecciona las que apliquen" data-live-search="true" data-width="30%" data-selected-text-format="count > 3" multiple="multiple">
<?php
...
?>	
                                        ...
                                        <div class="form-group">	
                                            <label><?php echo $lang['descripcion_del_clasificado']; ?></label>
                                            <textarea type="text" id="summernote_1" name="description" class="form-control"></textarea>
                                        </div>

                                        <div class="form-group">	
                                            <label><?php echo $lang['hacer_publico_clasificado']; ?></label>
                                            <div class="checkbox">
                                                <label><input type="hidden" name="make_public" value="0"></label>
                                                <label><input type="checkbox" name="make_public" value="1"><?php echo $lang['seguro_hacer_publico']; ?></label>
                                            </div>								    
                                        </div> 

                                        <div class="box-footer">
                                            <input type="hidden" name="token" value="<?php echo Token::generate(); ?>" />
                                            <button type="submit" name="data" class="btn btn-primary full-width"><?php echo $lang['enviar']; ?></button>
                                        </div>
                                    </form> 
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
