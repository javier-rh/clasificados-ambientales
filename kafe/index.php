        	...
        	<div class="row">
				<div class="banner-content">
					...
					<form action="searchpage.php" method="get" class="list-s">
						<button title="<?php echo $lang['search']; ?>"><i class="fa fa-search"></i></button>
						<input type="text" class="form-control" name="searchterm" placeholder="<?php echo $searchterm; ?>" value=""/>   
						<div class="clearfix"></div>
					</form>
					<p>
						<?php echo $lang['trending'] . " " . $lang['for'] . " " . $lang['services']; ?>:
						<?php
						...
						while ($row5 = mysqli_fetch_assoc($r5)) {
							...
							if($query->count()) {
								...
								foreach($query->results() as $row) {
									$List .= '<a href="searchcat.php?searchterm='. 
										escape($row->name) .
		...
		<div class="container">
			<div class="row">
				<div class="text-center">
		 			<h3><?php echo $lang['categories'];?> <?php echo $lang['popular']; ?></h3>
		 			<hr class="mint">
				</div> 
       		</div><!-- /.row -->
       		<br />
					...
					*/
            		...
            		/* Add one to the counter because a new post is being added to your page.  */ 
              		$postCounter += 1; 
		   			...
		   			echo $List .= '
			        <div class="col-lg-4">
					 <a href="searchcat.php?searchterm='. escape($row->name) .'" style="height: 295.4px;width:300px;">
