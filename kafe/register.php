	  ...
	  <nav role="navigation">
	    ...
	    <div class="collapse navbar-collapse navbar-main navbar-right">
	      <ul class="nav navbar-nav header-nav__navigation">
	        ...
	        <?php /*<li class="header-nav__navigation-item <?php echo $active = ($basename == 'faq') ? ' active' : ''; ?>">
            ...
            <ul class="list-group">
             <li class="list-group-item">
              <div class="material-switch pull-center">
	           ...
	           <span class="pull-right"><?php echo $lang['company']; ?></span>
              </div>
             </li>
            </ul> 
			 ...
			 <div class="form-foot">
			  <div class="form-actions">
			   ...
			   <input value="<?php echo $lang['registrar']; ?>" class="form-btn" type="submit">
			  </div><!-- /.form-actions -->
			 </div><!-- /.form-foot -->
		   </form>
