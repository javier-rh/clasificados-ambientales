	...
	<header id="header" headroom="" role="banner" tolerance="5" offset="700" class="navbar navbar-fixed-top navbar--white ng-isolate-scope headroom headroom--top">
	  <nav role="navigation">
	      ...
	      <ul class="nav navbar-nav header-nav__navigation">
	        ...
	        <li class="header-nav__navigation-item <?php echo $active = ($basename == 'services') ? ' active' : ''; echo $active = ($editname == 'freelancer.php?a='. Input::get('a').'&id='. Input::get('id').'') ? ' active' : ''; echo $active = ($editname == 'searchpage.php?searchterm='. Input::get('searchterm').'') ? ' active' : ''; ?>">
	          <a href="services.php" class="header-nav__navigation-link ">
	            <?php echo $lang['empresas_especializadas']; ?>
	          </a>
	        </li>
		 ...
		 if ($admin->isLoggedIn()) { ?>
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
						...
						<li class="m_2"><a href="Admin/profile.php?a=profile"><i class="fa fa-user"></i><?php echo $lang['mi']; ?> <?php echo $lang['profile']; ?></a></li>
		...
		<?php } elseif($client->isLoggedIn()) { ?>
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
						...
						<li class="m_2"><a href="Client/profile.php?a=profile"><i class="fa fa-user"></i><?php echo $lang['mi']; ?> <?php echo $lang['profile']; ?></a></li>
		...
		<?php } elseif($freelancer->isLoggedIn()) { ?>
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
						...
						<li class="m_2"><a href="Freelancer/profile.php?a=profile"><i class="fa fa-user"></i><?php echo $lang['mi']; ?> <?php echo $lang['profile']; ?></a></li>
		...
		<?php } else { ?>		 		        
	        ...
	        <li class="header-nav__navigation-item">
	          <a class="header-nav__navigation-link header-nav__navigation-link--outline" href="register.php"><?php echo $lang['signup']; ?> <?php echo $lang['free']; ?></a>
	        </li>
		 <?php } ?>              	        
	      </ul>
	    </div>
