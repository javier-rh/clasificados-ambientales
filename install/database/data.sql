...
(2, 'es', 'ltr', 'Spanish', 'spanish', 1, 0),
(3, 'ar', 'rtl', 'Arabic', 'arabic', 1, 0),
(4, 'it', 'ltr', 'Italian', 'italian', 1, 0),
(5, 'ja', 'ltr', 'Japanese', 'japanese', 1, 0),
(6, 'gr', 'ltr', 'German', 'german', 1, 0),
(7, 'hi', 'ltr', 'HIndi', 'hindi', 1, 0),
(8, 'fr', 'ltr', 'French', 'french', 1, 0),
(9, 'ru', 'ltr', 'Russian', 'russian', 1, 0);
...
INSERT INTO `<<prefix>>usergroups` (`group_id`, `group_removable`, `group_name`, `ad_duration`, `urgent_project_fee`, `featured_project_fee`, `highlight_project_fee`, `top_search_result`, `show_on_home`, `show_in_home_search`) VALUES
