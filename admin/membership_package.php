    ...
    <div class="container-fluid p-y-md">
        ...
        <div class="card">
            <div class="card-header">
                <h4>Paquetes de membresía</h4>
                <div class="pull-right">
                    <a href="#" data-url="panel/package_add.php" data-toggle="slidePanel" class="btn btn-success waves-effect waves-light m-r-10">Agregar paquete</a>
                </div>
            </div>
