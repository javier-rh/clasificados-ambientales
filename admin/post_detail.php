            ...
            <div class="card-header">
                <h4><?php echo $item_title; ?>
                    <span class="label-wrap hidden-sm hidden-xs">
                                    <?php
                                    if($item_featured == "1")
                                        echo '<span class="label featured"> Destacado</span>';
                                    if($item_urgent == "1")
                                        echo '<span class="label urgent"> Urgente</span>';
                                    if($item_highlight == "1")
                                        echo '<span class="label highlight"> Importante</span>';
                                    ?>
                                </span></h4>
            </div>
                        ...
                        <div class="col-sm-8" style="border: 0px solid #000;">
                            ...
                            <div class="item-box" style="margin-top: 20px">
                                <ul class="nav nav-tabs dark">
                                    <li class="active">
                                        <a data-toggle="tab" href="#4" aria-expanded="true">Detalles</a>
                                    </li>
                                </ul>
                                        ...
                                        <div>
                                            ...
                                            <div class="quick-info">
                                                <div class="detail-title">
                                                    <h2 class="title-left">Detalles adicionales</h2>
                                                </div>
                                                <ul class="clearfix">
                                                    <?php
...
<?
$item_suggestion_comments = 'Estimado '.$item_author_username.',



Saludos cordiales,
Equipo de Atención al Cliente
clasificadosAmbientales.com
';
?>
                                            <div id="SuggestionContainer">
                                                <h4>Sugerencias de edición</h4>
                                                <p>Para sugerir edición al usuario <? echo $item_author_username; ?> sobre este anuncio, escriba sus comentarios y por medio de mensaje directo de Atención al Cliente podrá recibir sus detalles.</p>
                                                <p><? if($msg !== '') echo $msg; ?></p>
                                                <form id="SuggestionForm" method="POST" action="./post_detail_suggestion.php">
                                                    <input type="hidden" id="item_id" name="item_id" value="<? echo ltrim(rtrim($item_id)); ?>" />
                                                    <input type="hidden" id="item_title" name="item_title" value="<? echo ltrim(rtrim($item_title)); ?>" />
                                                    <input type="hidden" id="item_author_username" name="item_author_username" value="<? echo ltrim(rtrim($item_author_username)); ?>" />
                                                    <textarea id="item_suggestion_comments" name="item_suggestion_comments" class="form-control" align="left" style="height:200px;"><? echo ltrim(rtrim($item_suggestion_comments)); ?></textarea><br />
                                                    <button id="suggestion_send" type="submit" class="btn btn-primary">Enviar</button>
                                                </form>
                                                <br>
                                            </div>
                                        </div>
                                ...
                                <div class="item-box fbold">
                                    <div class="pad-20 item-sale text-center ajax-item-listing" data-item-id="<?php echo $item_id ?>">
                                        ...
                                        if(isset($_GET['resubmit'])) {
                                            ...
                                            echo ' <button class="btn btn-success btn-rounded waves-effect waves-light m-r-5 btn-sm item-js-action" type="button" data-ajax-action="approveResubmitItem" data-ajax-type="approve"><span class="btn-label"><i class="ti-check"></i></span>Aprobar</button>';

                                            echo ' <button class="btn btn-danger btn-rounded waves-effect waves-light btn-sm  m-r-5 item-js-action" type="button" data-ajax-action="deleteResubmitItem" data-ajax-type="reject"><span class="btn-label"><i class="ti-trash"></i></span>Rechazar</button>';

                                        }
                                        else{
                                            if ($item_status == "pending") {
                                                echo ' <button class="btn btn-success btn-rounded waves-effect waves-light m-r-5 btn-sm item-js-action" type="button" data-ajax-action="approveitem" data-ajax-type="approve"><span class="btn-label"><i class="ti-check"></i></span>Aprobar</button>';
                                            }

                                            echo ' <button class="btn btn-danger btn-rounded waves-effect waves-light  m-r-5 btn-sm item-js-action" type="button" data-ajax-action="deleteads" data-ajax-type="delete"><span class="btn-label"><i class="ti-trash"></i></span>Borrar</button>';


                                        }

                                        echo ' <a class="btn btn-info btn-rounded waves-effect waves-light btn-sm mar-10" href="#" data-url="panel/post_edit.php?id='.$item_id.'" data-toggle="slidePanel"><span class="btn-label"><i class="ti-pencil"></i></span>Editar</a>';
                                        ?>
                            ...
                            if(isset($_GET['resubmit'])) {
                                ...
                                <div class="item-box">
                                    <div class="item-price">
                                        <div class="fbold">Mensaje al calificador</div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <div>
                                                    ...
                                                    <div class="align-left"><a href="<?php echo $item_author_link ?>" class="bylabel bylabelLarge" target="_blank">Ver Perfil</a></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="item-box meta-attributes">
                                <div class="pad-20">
                                    <table class="meta-attributes__table align-left" cellspacing="0" cellpadding="10" border="0">
                                        <tbody>
                                        <tr>
                                            <td class="meta-attributes__attr-name">ID del clasificado</td>
                                            <td class="meta-attributes__attr-detail"><?php echo $item_id ?></td>
                                        </tr>
                                        <tr>
                                            <td class="meta-attributes__attr-name">Vistas</td>
                                            <td class="meta-attributes__attr-detail"><?php echo $item_view ?></td>
                                        </tr>
                                        <tr>
                                            <td class="meta-attributes__attr-name">Estatus</td>
                                            <td class="meta-attributes__attr-detail"><?php echo $status ?></td>
                                        </tr>
                                        <tr>
                                            <td class="meta-attributes__attr-name">Publicado</td>
