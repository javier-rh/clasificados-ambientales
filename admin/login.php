                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            ...
                            <br>
                            <div class="card">
                                <h3 class="card-header h4">Iniciar sesión</h3>
                                    ...
                                    <form action="#" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="frontend_login_remember" class="css-input switch switch-sm switch-app">
                                                <input type="checkbox" id="frontend_login_remember" /><span></span> Recordar mis datos</a>
                                            </label>
                                        </div>
                                        <button type="submit" class="btn btn-app btn-block" name="login">Entrar</button>
                                    </form>
                                </div>
                                <!-- .card-block -->
                            </div>
