        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="pull-right">
                    <a class="btn btn-sm btn-warning" href="<?php echo SITEURL ?>/setting.php#quickad_email">Configuración de Correos</a>
                </div>
            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="email_template">Tipo de contenido de correo</label>
                                                    <p class="help-block">Selecciona texto plano o contenido HTML.</p>
                                                    <div>
                                                        <select name="email_template" id="email_template" class="form-control">
                                                            ...
                                                            <option <?php if(get_option( $config, "email_template") == '1'){ echo "selected"; } ?> value="1">Texto plano</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="panel panel-default quickad-main">
                                                    <div class="panel-body">
                                                        <h4 class="quickad-block-head">
                                                            <span class="quickad-category-title">Plantilla Email</span>
                                                        </h4>
                                                                                ...
                                                                                <div class="quickad-flexbox">
                                                                                    ...
                                                                                    <div class="quickad-flex-cell quickad-vertical-middle">
                                                                                        <a role="button" class="panel-title quickad-js-service-title collapsed" data-toggle="collapse" data-parent=".panel-group" href="#service_0" aria-expanded="false" aria-controls="service_1">
                                                                                            Detalles de cuenta de usuario </a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label>Asunto</label>
                                                                                        <input name="email_sub_signup_details" placeholder="Asunto" class="form-control" type="text" value="<?php echo get_option( $config, "email_sub_signup_details") ?>">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-0" <?php if($config['email_template'] != '0'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Mensaje</label>
                                                                                        <textarea name="email_message_editor_signup_details" rows="6" class="form-control" id="pageContent0" placeholder="Ingresa el mensaje"><?php echo get_option( $config, "email_message_signup_details") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Mensaje</label>
                                                                                        <textarea name="email_message_textarea_signup_details" rows="10" class="form-control" placeholder="Ingresa el mensaje"><?php echo get_option( $config, "email_message_signup_details") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="quickad-flexbox">
                                                                                    ...
                                                                                    <div class="quickad-flex-cell quickad-vertical-middle">
                                                                                        <a role="button" class="panel-title quickad-js-service-title collapsed" data-toggle="collapse" data-parent=".panel-group" href="#service_1" aria-expanded="false" aria-controls="service_1">
                                                                                            Confirmación de cuenta de correo </a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                                ...
                                                                                <div class="quickad-flexbox">
                                                                                    ...
                                                                                    <div class="quickad-flex-cell quickad-vertical-middle">
                                                                                        <a role="button" class="panel-title quickad-js-service-title collapsed" data-toggle="collapse" data-parent=".panel-group" href="#service_4" aria-expanded="false" aria-controls="service_4">
                                                                                            Email Comentarios y Sugerencias </a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                                ...
                                                                                <div class="quickad-flexbox">
                                                                                    ...
                                                                                    <div class="quickad-flex-cell quickad-vertical-middle">
                                                                                        <a role="button" class="panel-title quickad-js-service-title collapsed" data-toggle="collapse" data-parent=".panel-group" href="#service_7" aria-expanded="false" aria-controls="service_7">
                                                                                            Email del reenvío de aprobación del clasificado </a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                                ...
                                                                                <div class="quickad-flexbox">
                                                                                    ...
                                                                                    <div class="quickad-flex-cell quickad-vertical-middle">
                                                                                        <a role="button" class="panel-title quickad-js-service-title collapsed" data-toggle="collapse" data-parent=".panel-group" href="#service_9" aria-expanded="false" aria-controls="service_9">
                                                                                            Enviar notificación de clasificado al subscriptor </a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-9" <?php if($config['email_template'] != '0'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Mensaje</label>
                                                                                        <textarea name="email_message_editor_post_notification" rows="6" class="form-control" id="pageContent0" placeholder="Enter Message"><?php echo get_option( $config, "email_message_post_notification") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
