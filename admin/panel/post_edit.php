...
<header class="slidePanel-header overlay">
    <div class="overlay-panel overlay-background vertical-align">
        <div class="service-heading">
            <h2>Editar clasificado - <?php echo $item_title; ?></h2>
        </div>
                    ...
                    <form name="form2"  class="form form-horizontal" method="post" data-ajax-action="postEdit" id="sidePanel_form">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label">Estatus del clasificado</label>
                                <div class="col-sm-6">
                                    <select name="status" class="form-control">
                                        ...
                                        <option value="rejected" <?php if($status == 'rejected') echo "selected"; ?>>Rechazado</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label">SubCategoría</label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label">Título del clasificado:</label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <p class="help-block">Etiquetas html son permitidas.</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6" style="margin-left: 10px">
                                    <label class="css-input css-checkbox css-checkbox-primary">
                                        <input type="checkbox" name="featured" value="1" <?php if($item_featured == '1') echo "checked"; ?>><span></span> Destacado
                                    </label>
                                    <label class="css-input css-checkbox css-checkbox-primary">
                                        <input type="checkbox" name="urgent" value="1" <?php if($item_urgent == '1') echo "checked"; ?>><span></span> Urgente
                                    </label>
                                    <label class="css-input css-checkbox css-checkbox-primary">
                                        <input type="checkbox" name="highlight" value="1" <?php if($item_highlight == '1') echo "checked"; ?>><span></span> Importante
                                    </label>
                            ...
                            <div class="form-group hidden">
                                <label class="col-sm-4 control-label">Opciones de contacto:</label>
