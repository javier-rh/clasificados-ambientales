                    ...
                    <form name="form2"  class="form form-horizontal" method="post" data-ajax-action="addStaticPage" id="sidePanel_form">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label>Slug:</label>
                                    <input name="slug" type="text" class="form-control" placeholder="Ingresa el ID de la página">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label>Nombre:</label>
                                    <input name="name" type="text" class="form-control"  placeholder="Nombre de la página">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label>Título:</label>
                                    <input name="title" type="text" class="form-control"  placeholder="Título de la página">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <select name="type" id="type" class="form-control">
                                        ...
                                        <option value="1">Sólo conectado</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label class="css-input switch switch-sm switch-success">
                                        <strong>Activo</strong> <input  name="active" type="checkbox" value="1" checked=""/><span></span>
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <textarea name="content" rows="6" id="pageContent" class="form-control" placeholder="Ingresa el contenido de la página"></textarea>
                                </div>
                            </div>
