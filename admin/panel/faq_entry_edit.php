...
<header class="slidePanel-header overlay">
    <div class="overlay-panel overlay-background vertical-align">
        <div class="service-heading">
            <h2>Editar entrada Pregunta Frecuente</h2>
        </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label class="css-input switch switch-sm switch-success">
                                        <strong>Activo</strong> <input  name="active" type="checkbox" value="1" <?php if($quick_fetch['active'] == '1') echo "checked"; ?> /><span></span>
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label>Contenido de la pregunta frecuente:</label>
