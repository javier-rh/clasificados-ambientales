                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputfullname" placeholder="Nombre completo" name="name" value="<?php echo $fetch['name'];?>">
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
                                </div>

                                <h4 class="box-title m-b-0">Configuración de la cuenta</h4>
                                <hr>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="ion-person"></i></div>
                                            <input type="text" class="form-control" id="exampleInputuname" placeholder="Nombre de usuario" name="username" value="<?php echo $fetch['username'];?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control" id="exampleInputpwd2" placeholder="Ingresa la nueva contraseña" name="newPassword">
                                        </div>
                                    </div>
                                </div>
                            </div>
