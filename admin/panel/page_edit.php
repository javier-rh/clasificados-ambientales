                    ...
                    <form name="form2"  class="form form-horizontal" method="post" data-ajax-action="editStaticPage" id="sidePanel_form">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label>Slug:</label>
                                    <input name="slug" type="text" class="form-control" placeholder="Ingresa el ID de la página" value="<?php echo $fetch['slug']?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label>Nombre:</label>
                                    <input name="name" type="text" class="form-control"  placeholder="Nombre de la página" value="<?php echo $fetch['name']?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label>Título:</label>
                                    <input name="title" type="text" class="form-control"  placeholder="Título de la página" value="<?php echo $fetch['title']?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <select name="type" id="type" class="form-control">
                                        <option value="0" <?php if($status == '0') echo "selected"; ?>>Estandar</option>
                                        <option value="1" <?php if($status == '1') echo "selected"; ?>>Sólo conectado</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label class="css-input switch switch-sm switch-success">
                                        <strong>Activo</strong> <input  name="active" type="checkbox" value="1" <?php if($fetch['active'] == '1') echo "checked"; ?> /><span></span>
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <textarea name="content" rows="6" id="pageContent" class="form-control" placeholder="Ingresa el contenido de la página"><?php echo $fetch['content']?></textarea>
                                </div>
                            </div>
