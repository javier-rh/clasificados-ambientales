    ...
    <div class="slidePanel-inner">
        <div class="user-btm-box">
            ...
            <div class="row text-center m-t-10">
                <div class="col-md-6 b-r"><strong>Nombre</strong><p><?php echo $fetchuser['name'];?></p></div>
                <div class="col-md-6"><strong>Género</strong><p><?php echo $fetchuser['sex'];?></p></div>
            </div>
            <!-- /.row -->
            <hr>
            <!-- .row -->
            <div class="row text-center m-t-10">
                ...
                <div class="col-md-6"><strong>Registrado desde</strong><p><?php echo date('dS M g:iA', strtotime($fetchuser['created_at'])); ?></p></div>
            </div>
            <!-- /.row -->
            <hr>
            <!-- .row -->
            <div class="row text-center m-t-10">
                <div class="col-md-12"><strong>Acerca de</strong><p class="m-t-30"><?php echo $fetchuser['description'];?></p></div>
