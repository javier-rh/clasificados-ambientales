        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="pull-right">
                    <a href="#" data-url="panel/users_add.php" data-toggle="slidePanel" class="btn btn-success waves-effect waves-light m-r-10">Agregar Usuario</a>
                </div>
            </div>
                ...
                <div id="js-table-list">
                    <table id="ajax_datatable" data-jsonfile="users.php" class="js-table-checkable table table-vcenter table-hover" data-tablesaw-mode="stack" data-plugin="animateList"
                        ...
                        <tr>
                            ...
                            <th><i class="ion-image"></i> Usuario</th>
                            <th class="w-10">Email</th>
                            <th class="hidden-xs w-30" style="width: 100px;">Género</th>
                            <th class="hidden-xs hidden-sm" style="width:100px">Estatus</th>
                            <th class="hidden-xs w-30" style="width: 100px;">Registrado</th>
