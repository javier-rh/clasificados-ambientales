    ...
    <?php
        ...
        if(isset($_POST['zechat_on_off'])){
            ...
            if($zechat_purchase == NULL) {
                $message .= '<span style="color:red;">(Ingresa un código de compra válido para Zechat)</span>';
            }
            else{
        ...
        if(isset($_POST['wchat_on_off'])){
            ...
            if($wchat_purchase == "") {
                $message .= '<span style="color:red;">(Ingresa un código de compra válido para Wchat)</span>';
            }
            else{
                    ...
                    <div class="form-body">
                        ...
                        if(isset($config['zechat_purchase_code']) && $config['zechat_purchase_code'] != ""){
                            ...
                            <div class="form-group bt-switch">
                                <label class="col-sm-4 control-label">Zechat activado/desactivado:</label>
                                <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label class="col-sm-4 control-label">Código de compra Zechat:</label>
                            <div class="col-sm-6">
                                <?php
                                if(isset($config['zechat_purchase_code']) && $config['zechat_purchase_code'] != ""){
                                    ?>
                                    <div class="alert alert-success">
                                        <strong>¡Aprobado!</strong> Código de compra Zechat verificado, ahora puedes activarlo/desactivarlo</div>
                                <?php
                                }
                                ?>
                                <input name="zechat_purchase_code" type="password" class="form-control" value="">
                                <span class="font-14"><code style="color: green">Adquiere un código de compra aquí.</code><a href="https://codecanyon.net/item/facebook-style-php-ajax-chat-zechat/16491266?clickthrough_id=16491266&license=regular&open_purchase_for_item_id=16491266&purchasable=source&redirect_back=true&ref=bylancer&utm_source=item_desc_link" target="_blank">Comprar Zechat</a></span>
                            </div>
                        </div>
                        ...
                        if(isset($config['wchat_purchase_code']) && $config['wchat_purchase_code'] != ""){
                            ?>
                            <div class="form-group bt-switch">
                                <label class="col-sm-4 control-label">Wchat activado/desactivado:</label>
                                <div class="col-sm-6">
                                    <label class="css-input switch switch-success">
                        ...
                        ?>
                        <div class="form-group">
                            <label class="col-sm-4 control-label">Código de compra Wchat:</label>
                            <div class="col-sm-6">
                                <?php
                                if(isset($config['wchat_purchase_code']) && $config['wchat_purchase_code'] != ""){
                                    ?>
                                    <div class="alert alert-success">
                                        <strong>¡Aprobado!</strong> Código de compra Wchat verificado, ahora puedes activarlo/desactivarlo</div>
                                <?php
                                }
                                ?>
                                <input name="wchat_purchase_code" type="password" class="form-control" value="">
                                <span class="font-14"><code style="color: green">Adquiere un código de compra aquí.</code><a href="https://codecanyon.net/item/wchat-fully-responsive-phpajax-chat/18047319?clickthrough_id=18047319&license=regular&open_purchase_for_item_id=18047319&purchasable=source&redirect_back=true&ref=bylancer&utm_source=item_desc_link" target="_blank">Comprar Wchat</a></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <button name="update" type="submit" class="btn btn-primary btn-radius save-changes">Guardar</button>
                            </div>
                        </div>
                        <!--Default Horizontal Form-->
