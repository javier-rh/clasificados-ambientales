        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="pull-right">
                    <a href="setting.php#quickad_theme_setting" class="btn btn-success waves-effect waves-light m-r-10">Configuración de Temas</a>
                </div>
            </div>
                                ...
                                <div class="white-box pro-box p-0">
                                    ...
                                    <div class="pro-content-3-col">
                                        <div class="pro-list-details">
                                            ...
                                            <h4 class="text-danger"><small>Autor</small> <?php echo $themeinfo['Author'] ?></h4> Precio: <?php echo $themeinfo['Price'] ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="pro-agent-col-3">
                                        <div class="agent-name">
                                            <form action="themes.php" method="post" name="f1" id="f1">
                                                ...
                                                {
                                                    echo '<button class="btn btn-default btn-rounded waves-effect waves-light btn-sm" type="button"><span class="btn-label"><i class="ti-check"></i></span>Tema actual</button>';
                                                }
                                                else{
                                                    echo '<button class="btn btn-success btn-rounded waves-effect waves-light btn-sm" type="submit"><span class="btn-label"><i class="ti-check"></i></span>Activar</button>';
                                                }
                                                ?>
                                            </form>
                                        </div>
